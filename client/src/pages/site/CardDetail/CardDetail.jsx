                ...
                <div className="row">
                  <div className="col-xl-6 col-lg-8 col-md-8">
                    <div className="hero__caption hero__caption2">
                      <h1 data-animation="fadeInUp" data-delay=".4s">Card Details</h1>
                      <p style={{ fontSize: "15px", fontWeight: "500", color: "white" }}>Home > Card Details</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row s_product_inner">
              <div className="col-lg-5">
                <div className="product_slider_img">
                  <div id="vertical">
                    {itemData.images && itemData.images.map((image, index) => (
              ...
              <div className="col-lg-5 offset-lg-1">
                <div className="s_product_text">
                  ...
                  <ul className="list">
                    ...
                    <li>
                      <a href="#">
                        <span>Availability</span> : {itemData.availability ? 'In Stock' : 'In Stock'}
                      </a>
                    </li>
                  </ul>
